...
public class OutputView {
    ...
    public void printData() {
        ...
        for (int i = 0; i < histogramObj.histogram.size(); i++) {  //The static field Histogram.histogram should be accessed in a static way 이게 무슨 말일까?
    ...
    public void printNameOfData(int i) {
        System.out.print(histogramObj.nameOfData.get(i));
    }

    public void printDataType(int i) {
        System.out.print(DataType.convertCodeToType(histogramObj.dataType.get(i)));
    }

    public void printBars(int i) {
        System.out.println(histogramObj.histogram.get(i));
    }
    ...
    public void printAverage() {
        ...
        System.out.println(histogramObj.ave);
    }
